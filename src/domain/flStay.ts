...
//
// デッキ差に注意: 本実装は標準52枚デッキ。実測継続率（100万ハンド、95%CI ±0.1%）は
//   52枚: {13:5.9%, 14:10.5%, 15:19.5%, 16:34.7%, 17:54.8%}
// 一方、ジョーカー2枚入り（54枚・ワイルド）のルームでは継続率が大きく上がる。同じ
// リステイ条件でワイルド対応の厳密判定を組んで実測（5万ハンド、±0.4%）した参考値:
//   54枚: {14:37.7%, 15:50.3%, 16:63.9%, 17:77.9%}
